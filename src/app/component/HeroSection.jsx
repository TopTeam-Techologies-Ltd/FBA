        ...
        <div className="h-full">
          <div className="flex flex-col justify-center items-center h-full">
            <div className="w-[60%] mx-auto text-center">
              <h1 className="text-5xl font-extrabold  text-[#fff] drop-shadow-lg mb-3">
                Fatima Bolanle Abioye Foundation
              </h1>
              <h1 className="text-2xl font-extrabold text-[#fff] drop-shadow-lg mb-3">
                (FBA Foundation)
              </h1>
              <br />
              <span className="text-base text-[#fff] drop-shadow-md mb-3">
