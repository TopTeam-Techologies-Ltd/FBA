  ...
  return (
    <>
      <form
        ...
        className="w-[50rem] mx-auto p-6 bg-white shadow-lg rounded-lg mb-10 relative"
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            <option value="cloud-azure-intermediate">Cloud computing with azure (Intermediate level)</option>
          </select>
